...
public class RobotDrive implements MotorSafety, IUtility {
    ...
    public void mecanumDrive_Cartesian(double x, double y, double rotation, double gyroAngle)
    {
        ...
        wheelSpeeds[MotorType.kFrontLeft_val] = (xIn + yIn + rotation) * 1;
        wheelSpeeds[MotorType.kFrontRight_val] = (-xIn + yIn - rotation) * 1;
        wheelSpeeds[MotorType.kRearLeft_val] = (-xIn + yIn + rotation); // slow
        wheelSpeeds[MotorType.kRearRight_val] = (xIn + yIn - rotation) * 1;
